...
import com.example.classroom.view.dataView.DataViewHolderAtividades

class AdapterAtividades(controller: Controller) : DataAdapter(controller) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_list_atividades, parent, false)
        return DataViewHolderAtividades(view)
    }
}